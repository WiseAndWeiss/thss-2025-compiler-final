...
if_then_1:
    ...
    %icmp_eq_temp14 = icmp eq i32 1, 1
    br i1 %icmp_eq_temp14, label %if_then_2, label %if_end_2
if_then_2:
    %load_temp15 = load i32, i32* %e, align 4
    %mul_temp16 = mul i32 %load_temp15, 2
    store i32 %mul_temp16, i32* %c, align 4
    br label %if_end_2
if_end_2:
    br label %if_end_1
if_end_1:
...
entry:
    ...
    %load_temp18 = load i32, i32* %p, align 4
    %load_temp19 = load i32, i32* %p, align 4
    %call_temp20 = call i32 @deepWhileBr(i32 %load_temp18, i32 %load_temp19)
    ret i32 %call_temp20
}
